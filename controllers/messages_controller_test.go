...
var (
	getMessageService func(msgId int64) (*dto.Message, error_utils.MessageErr)
	createMessageService func(message *dto.Message) (*dto.Message, error_utils.MessageErr)
	updateMessageService func(message *dto.Message) (*dto.Message, error_utils.MessageErr)
	deleteMessageService func(msgId int64) error_utils.MessageErr
	getAllMessageService func() ([]dto.Message, error_utils.MessageErr)
)

type serviceMock struct {}

func (sm *serviceMock) GetMessage(msgId int64) (*dto.Message, error_utils.MessageErr) {
	return getMessageService(msgId)
}
func (sm *serviceMock) CreateMessage(message *dto.Message) (*dto.Message, error_utils.MessageErr) {
	return createMessageService(message)
}
func (sm *serviceMock) UpdateMessage(message *dto.Message) (*dto.Message, error_utils.MessageErr) {
...
func (sm *serviceMock) GetAllMessages() ([]dto.Message, error_utils.MessageErr) {
...
func TestGetMessage_Invalid_Id(t *testing.T) {
	...
	apiErr, err := error_utils.NewApiErrorMessageFromBytes(rr.Body.Bytes())
	assert.Nil(t, err)
...
func TestGetMessage_Message_Not_Found(t *testing.T) {
	services.MessagesService = &serviceMock{}
	getMessageService = func(msgId int64) (*dto.Message, error_utils.MessageErr) {
		return nil, error_utils.NewNotFoundErrorMessage("message not found")
	}
	msgId := "1" //valid id
	r := gin.Default()
	req, _ := http.NewRequest(http.MethodGet, "/messages/"+msgId, nil)
...
func TestGetMessage_Message_Database_Error(t *testing.T) {
	services.MessagesService = &serviceMock{}
	getMessageService = func(msgId int64) (*dto.Message, error_utils.MessageErr) {
		return nil, error_utils.NewInternalServerErrorMessage("database error")
	}
	msgId := "1" //valid id
	r := gin.Default()
	req, _ := http.NewRequest(http.MethodGet, "/messages/"+msgId, nil)
...
func TestCreateMessage_Empty_Body(t *testing.T) {
	services.MessagesService = &serviceMock{}
	createMessageService = func(message *dto.Message) (*dto.Message, error_utils.MessageErr) {
		return nil, error_utils.NewUnprocessibleEntityErrorMessages("Please enter a valid body")
	}
...
func TestCreateMessage_Empty_Title(t *testing.T) {
	services.MessagesService = &serviceMock{}
	createMessageService = func(message *dto.Message) (*dto.Message, error_utils.MessageErr) {
		return nil, error_utils.NewUnprocessibleEntityErrorMessages("Please enter a valid title")
	}
...
func TestUpdateMessage_Error_Updating(t *testing.T) {
	services.MessagesService = &serviceMock{}
	updateMessageService = func(message *dto.Message) (*dto.Message, error_utils.MessageErr) {
		return nil, error_utils.NewInternalServerErrorMessage("error when updating message")
	}
	jsonBody := `{"title": "update title", "body": "update body"}`
	r := gin.Default()
	id := "1"
...
func TestDeleteMessage_Failure(t *testing.T) {
	services.MessagesService = &serviceMock{}
	deleteMessageService = func(msg int64) error_utils.MessageErr {
		return error_utils.NewInternalServerErrorMessage("error deleting message")
	}
	r := gin.Default()
	id := "1"
	req, err := http.NewRequest(http.MethodDelete, "/messages/"+id, nil)
...
func TestGetAllMessages_Failure(t *testing.T) {
	services.MessagesService = &serviceMock{}
	getAllMessageService = func() ([]dto.Message, error_utils.MessageErr) {
		return nil, error_utils.NewInternalServerErrorMessage("error getting messages")
	}
	r := gin.Default()
	req, err := http.NewRequest(http.MethodGet, "/messages", nil)
	if err != nil {
