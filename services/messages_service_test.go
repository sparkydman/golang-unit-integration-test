...
var (
	tm = time.Now()
	getMessageDomain func(messageId int64) (*dto.Message, error_utils.MessageErr)
	createMessageDomain func(msg *dto.Message) (*dto.Message, error_utils.MessageErr)
	updateMessageDomain func(msg *dto.Message) (*dto.Message, error_utils.MessageErr)
	deleteMessageDomain func(messageId int64) error_utils.MessageErr
	getAllMessagesDomain func() ([]dto.Message, error_utils.MessageErr)
)

type getDBMock struct {}

func (m *getDBMock) Get(messageId int64) (*dto.Message, error_utils.MessageErr){
	return getMessageDomain(messageId)
}
func (m *getDBMock) Create(msg *dto.Message) (*dto.Message, error_utils.MessageErr){
	return createMessageDomain(msg)
}
func (m *getDBMock) Update(msg *dto.Message) (*dto.Message, error_utils.MessageErr){
...
func (m *getDBMock) GetAll() ([]dto.Message, error_utils.MessageErr) {
...
func TestMessagesService_GetMessage_Success(t *testing.T) {
	...
	dao.MessageRepo = &getDBMock{} //this is where we swapped the functionality
	getMessageDomain = func(messageId int64) (*dto.Message, error_utils.MessageErr) {
		return &dto.Message{
			Id:        1,
			Title:     "the title",
...
func TestMessagesService_GetMessage_NotFoundID(t *testing.T) {
	dao.MessageRepo = &getDBMock{}
	//MessagesService = &serviceMock{}

	getMessageDomain = func(messageId int64) (*dto.Message, error_utils.MessageErr) {
		return nil, error_utils.NewNotFoundErrorMessage("the id is not found")
	}
	msg, err := MessagesService.GetMessage(1)
	assert.Nil(t, msg)
	assert.NotNil(t, err)
...
func TestMessagesService_CreateMessage_Failure(t *testing.T) {
	dao.MessageRepo = &getDBMock{}
	createMessageDomain  = func(msg *dto.Message) (*dto.Message, error_utils.MessageErr){
		return nil, error_utils.NewBadRequestErrorMessage("title already taken")
	}
	request := &dto.Message{
		Title:     "the title",
		Body:      "the body",
...
func TestMessagesService_UpdateMessage_Failure_Getting_Former_Message(t *testing.T) {
	dao.MessageRepo = &getDBMock{}
	getMessageDomain  = func(messageId int64) (*dto.Message, error_utils.MessageErr) {
		return nil, error_utils.NewInternalServerErrorMessage("error getting message")
	}
	request := &dto.Message{
		Title:     "the title update",
		Body:      "the body update",
...
func TestMessagesService_UpdateMessage_Failure_Updating_Message(t *testing.T) {
	...
	updateMessageDomain  = func(msg *dto.Message) (*dto.Message, error_utils.MessageErr){
		return nil, error_utils.NewInternalServerErrorMessage("error updating message")
	}
	request := &dto.Message{
		Title:     "the title update",
		Body:      "the body update",
...
func TestMessagesService_DeleteMessage_Error_Getting_Message(t *testing.T) {
	dao.MessageRepo = &getDBMock{}
	getMessageDomain  = func(messageId int64) (*dto.Message, error_utils.MessageErr) {
		return nil, error_utils.NewInternalServerErrorMessage("Something went wrong getting message")
	}
	err := MessagesService.DeleteMessage(1)
	assert.NotNil(t, err)
